...
<label>Enter the Question Text (multiple lines supported)</label>
<textarea 
...
<div class="language-input" hidden>
<label>Hindi</label>
<textarea 
...
<div class="language-inputs">
<div class="language-input">
<label>Enter the Option Text (multiple lines supported)</label>
<textarea
...
<div class="language-inputs">
<div class="language-input">
<label>Enter keywords (Multiple lines supported)</label>
<textarea 
